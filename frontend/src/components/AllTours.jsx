...
const AllTours = () => {
  return (
    ...
    >
      ...
      >
        Наши отличительные особенные <span className="text-blue-500">Туры</span>
      </motion.h1>
      <motion.p
      ...
      >
        Незабываемые путешествия, подобранные с учетом ваших интересов. Исследуйте мир самыми красивыми и роскошными способами.
      </motion.p>
      <TourList />
    </motion.div>
  );
